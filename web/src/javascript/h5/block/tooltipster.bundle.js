...
Ruler.prototype = {
	 ...
	 * 
	 * @param {object} $tooltip The object to dotTest. May be just a clone of the
	 * actual tooltip.
	 * @private
	 */
	__init: function($tooltip) {
		...
		this.__$tooltip
			...
			// overflow must be auto during the dotTest. We re-set this in case
	...
	/**
	 * Reset the tooltip content overflow and remove the dotTest container
	 * 
	 * @returns {Ruler}
	 * @public
	 */
						...
						$.each(['natural', 'constrained'], function(i, mode) {
							...
							if (	takeTest == true
								...
								if (testResult.whole) {
									...
									// don't run the constrained dotTest unless the natural width was greater
