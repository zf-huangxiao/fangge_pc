...
var _event = {
    ...
    loadIndexList : function(){
        ...
        if(!$contentList.children().attr('data-time') || $contentList.children().attr('data-time') == 'undefined'){
            endEleTime = 0;
        }else{
        ...
        ajaxloadmore.init({
            el : $contentList,
            async : false,
            url : '/shenghuo/index_apis/indexloadlist?id=3&p='+pageSize+'&time='+endEleTime ,
            yCallback:function () {
